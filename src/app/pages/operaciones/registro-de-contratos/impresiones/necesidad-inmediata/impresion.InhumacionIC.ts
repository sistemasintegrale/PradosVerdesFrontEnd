...
export function ImprimirInhumacionIC(item: ContratoImpresion) {
  ...
  currentX += 20;
  doc.text("Al concluir la inhumación en cualquier nivel (1, 2, 3, 4, 5, 6), se colocará una plancha de madera para cubrir el espacio hasta llenar la sepultura.", currentX, initialY, { maxWidth: 150 })
  skipLine(2);
  doc.text("Solo se sellará la sepultura I/C cuando ingrese el 6to nivel.", currentX, initialY, { maxWidth: 150 })
  skipLine();
  ...
  doc.save(`Inhumación IC - ${item.numeroContrato}.pdf`);

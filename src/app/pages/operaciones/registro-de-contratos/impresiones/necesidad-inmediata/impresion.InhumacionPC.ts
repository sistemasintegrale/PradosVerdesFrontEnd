...
export function ImprimirInhumacionPC(item: ContratoImpresion) {
  ...
  currentX += 20;
  doc.text("Los niveles que corresponden a este espacio son de 5 niveles y cada vez que se requiera hacer uso del siguiente nivel se va realizar la apertura hasta culminar los niveles.", currentX, initialY, { maxWidth: 150 })
  skipLine(2);
  doc.text("Al finalizar la ceremonia se colocará una lápida provisional.", currentX, initialY, { maxWidth: 150 })
  skipLine();
  doc.text("La lápida de mármol se colocará de 30 a 45 días hábiles aproximadamente.", currentX, initialY, { maxWidth: 150 })
  skipLine(1.5);
